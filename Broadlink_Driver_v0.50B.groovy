 ...
 *      by CybrMage
 *
 *	Jun 29, 2020	add clearCodeStore command (AAB)
 *	Jun 02, 2020	Add workaround at 977 for new RM Mini3 not going into learn mode
 *
***********************************************************************************************************************/
public static String version()      {  return "v0.50B  2020-06-29" }
...
def parseDataIR(description) {
	...
	if (dErr == 0) {
		...
		if ((payload == null) || (payload.size() == 0)) {
			...
			pauseExecution(1500)
//		workaround for new series Rm Mini3 not going into learn mode
//		code from https://community.hubitat.com/t/beta-native-broadlink-rm-rm-pro-rm-mini-sp-driver-rc-hvac-manager/31344/357
//		} else if (payload[0] == 4) {
		} else {
